...
- Прогресс пишем не чаще раза в 10 секунд и на `pause`/`ended`/уходе со
  страницы. Неавторизованным — в память вкладки, без записи в БД. Аккаунтов
  пока нет, поэтому весь прогресс — во вкладке.
